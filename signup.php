            ...
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-6 col-lg-offset-3 text-center">
						<form role="form" action="process/insert.php" method="post" class="login-form">
	    			       <div class="form-group">
								<label>Nama Lengkap:</label><br>
								<input type="text" name="form-nama" class="form-control" autofocus="autofocus">
								<br>
								<label>Nomor HP:</label><br>
								<input type="text" name="form-nohp" class="form-control">
								<br>
							...
							<input type="hidden" name="jenis" value="sign-up">
